...
namespace mentorship_program_tool.Services
{
    public class EmployeeService : IEmployeeService
    {
        ...
        public async Task<IEnumerable<EmployeeModel>> GetEmployeesWithOffsetLimitAsync(int offset, int limit)
        {
            return await _unitOfWork.Employee.GetWithOffsetLimitAsync(offset, limit);
        }
